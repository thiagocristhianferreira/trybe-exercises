...
// um navio, retorna o comprimento dele, mostrando também a devida unidade de comprimento:
...
const shipLength = (parametro) => {
    const { name, length, measurementUnit = 'meters' } = parametro;
